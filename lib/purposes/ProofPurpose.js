...
module.exports = class ProofPurpose {
  /**
   * @param {string} term the `proofPurpose` term, as defined in the
   *    SECURITY_CONTEXT_URL `@context` or a URI if not defined in such.
   * @param {string|Date|integer} [date] - The expected date for
   *   the creation of the proof.
   * @param {integer} [maxTimestampDelta] - A maximum number of seconds that
